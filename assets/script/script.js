...
function playerTurn(currentPlayer) {
    ...
    if (currentPlayer.position > 0 && currentPlayer.position < 25) {
...
//             alert("Contratulations! You've won!");
//         } else {
//             alert("EvilBoy won thist time!");
//         }
//     }
// }
...
//game lasts while avatar not on End / i <=25)//